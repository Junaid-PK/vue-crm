...
import EditTeamLeads from "./views/TeamLeads/EditTeamLead.vue";
...
const routes = [
  {
    ...
    children: [
      { path: "", name: "Dashboard", component: ManageDepartments },
      ...
      { path: "edit-team-lead", name: "EditTeamLeads", component: EditTeamLeads },
